...
#'
#' @description This dataset was compiled by Morais and Bellwood (2018). The original version can be accessed in the Supporting Information - DS1 of this article including the references, locality names and complete names of the categorical traits levels. This is a streamlined version with variables formatted to be used directly within the function \code{\link{predKmax}}.
#' 
#' @format A data frame with 1921 rows and 16 variables:
#' \describe{
...
#'   \item{Position}{Position relative to the reef, combining horizontal and vertical components, in six levels, see original dataset}
